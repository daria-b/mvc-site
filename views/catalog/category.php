...
<div id="content">
    ...
    <div id="leftblock">
        ...
        <?php foreach($categories as $categoryItem): ?>
            ...
            <a href="/category/<?php echo $categoryItem['id']; ?>" class="<?php if ($categoryId == $categoryItem['id']) echo 'actives'; ?> cat-title" >
        ...
        <form action="http://www.technoshop.ho.ua/category/<?php echo $categoryId; ?>/priceup/" method="post">
            <p><input class="sort" type="submit" name="submit" value="Цена по возрастанию"></p>
        </form>


        <form action="http://www.technoshop.ho.ua/category/<?php echo $categoryId; ?>/pricedown/" method="post">
            <p><input class="sort" type="submit" name="submit" value="Цена по убыванию"></p>
        </form>


        <form action="http://www.technoshop.ho.ua/category/<?php echo $categoryId; ?>/nameup/" method="post">
            <p><input class="sort" type="submit" name="submit" value="Бренд от A до Z"></p>
        </form>


        <form action="http://www.technoshop.ho.ua/category/<?php echo $categoryId; ?>/namedown/" method="post">
