...
class Product
{
    ...
    // Возращает список рекомендуемых товаров
    ...
    // Добавляет новый товар (получает - массив с информацией о товаре, возращает - id добавленной в таблицу записи)
    ...
    public static function getImage($id)
    {
        ...
        $path = '/php/site/upload/images/products/';
